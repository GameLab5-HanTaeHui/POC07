...
attackCooldown     : 2.0
attackDuration     : 0.3
playerLayer        : Player *          (EnemySensor 탐지용)
groundLayer        : Ground + Wall *   (지형 감지용)
attackHitLayer     : Player *          (v0.16 추가 — 공격 히트박스 전용)
chargeDetectRange  : 5.0               (v0.16 추가 — 차징 발동 범위)
chargeSpeed        : 14                (v0.16 추가)
chargeDuration     : 0.8               (v0.16 추가)
chargeDamage       : 25                (v0.16 추가)
chargeKnockbackMultiplier : 2.0        (v0.16 추가)
chargeCooldown     : 5.0               (v0.16 추가)
```
